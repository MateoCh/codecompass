...
class Query():
    def __init__(self, hierarchy, directory="C:/Users/lrodr/OneDrive - Universidad de los Andes/laura/2023-2/CodeSavant/codecompass/prueba"):
...
# hierarchy = r"""
#                 C:\Users\lrodr\OneDrive - Universidad de los Andes\laura\2023-2\CodeSavant\prueba
#                 + content/
#                     - main.py
#                     - pets.txt
#                     - pets2.txt
...
if __name__ == '__main__':
    ...
    f = open ('C:/Users/lrodr/OneDrive - Universidad de los Andes/laura/2023-2/CodeSavant/codecompass/src/scripts/hierarchy.txt','r')
    mensaje = f.read()
    print(mensaje)
    f.close()
    p = Query(mensaje)
    ...
    # while True:
    # query = "What food should I give to my dog?" # str(input("Query: "))
    # print(p.make_query(query))
    # print(p.make_query(query).keys)
    # print()
    answer = p.make_query(query)["answer"]
    f = open ('C:/Users/lrodr/OneDrive - Universidad de los Andes/laura/2023-2/CodeSavant/codecompass/src/scripts/answer.txt','w')
    f.write(answer)
    f.close()
    print(answer)
